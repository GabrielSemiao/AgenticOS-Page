      ...
      <div className="relative flex h-full">
        ...
        <div className="w-16 bg-black/40 backdrop-blur-md border-r border-white/5 flex flex-col items-center py-6 gap-6">
          ...
          <div className="flex-1 flex flex-col gap-4">
            <motion.div
              ...
              className="w-10 h-10 rounded-lg bg-purple-500/20 border border-purple-500/30 flex items-center justify-center cursor-pointer shadow-lg shadow-purple-500/20"
            >
        ...
        <div className="flex-1 p-6 overflow-hidden">
          ...
          <div className="mb-6">
            ...
            <p className="text-sm text-zinc-500">Real-time analytics & performance</p>
          </div>
            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs text-zinc-500 uppercase tracking-wider">AI Performance</span>
                </div>
