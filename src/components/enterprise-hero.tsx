    ...
    <div className="h-svh w-full relative flex flex-col items-center justify-center antialiased overflow-hidden">
      ...
      <div className="relative z-20 flex flex-col items-center gap-8 text-center px-6 md:px-4 pointer-events-none">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 bg-black border border-zinc-800 rounded-full px-4 py-2 pointer-events-auto"
        >
          ...
          <span className="text-zinc-400 text-sm font-light">
            Novidade: Gateway Nativo com Taxa Reduzida
          </span>
        </motion.div>
        ...
        >
          Não contrate mais funcionários, instale o AgenticOS. O único Sistema Operacional com Banco Digital Nativo que negocia, vende e processa pagamentos via Pix no WhatsApp 24/7. Sem gateways externos.
        </motion.p>
